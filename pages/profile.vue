<template>
    <div class="flex max-lg:flex-col gap-8 grow">
        ...
        <div class="w-full lg:w-2/3 h-full">
            ...
            <!-- статистика -->
            <div v-if="tabs === 'stats'" class="flex flex-col gap-8 p-4 rounded-xl border border-white/20">
                <div class="flex flex-col gap-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div class="flex flex-col gap-2 bg-[#201e18] items-center text-center p-4 rounded-xl">
                            <div class="flex items-center justify-center p-2 rounded-xl bg-purple-500/10">
                                <Icon class="text-3xl" name="heroicons:calendar-days-20-solid"/>
                            </div>
                            <p class="text-2xl md:text-3xl font-mono font-semibold">7</p>
                            <p class="text-purple-400">Дней активности</p>
                        </div>
                    </div>
                </div>
                <div class="flex flex-col gap-6">
